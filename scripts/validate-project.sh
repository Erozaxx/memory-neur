#!/usr/bin/env bash
# validate-project.sh — validuje frontmatter lore/projects/*.md
#
# Použití:
#   scripts/validate-project.sh <cesta-k-md-souboru>
#
# Exit kódy:
...
ALLOWED_TYPES=("internal" "client" "oss" "experiment")
ALLOWED_STATUS=("active" "paused" "completed" "abandoned")
