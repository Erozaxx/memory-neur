#!/usr/bin/env bash
# validate-process.sh — validuje frontmatter lore/processes/*.md
#
# Použití:
#   scripts/validate-process.sh <cesta-k-md-souboru>
#
# Exit kódy:
...
ALLOWED_TYPES=("workflow" "checklist" "ritual" "automation")
