#!/usr/bin/env bash
# validate-decision.sh — validuje frontmatter lore/decisions/*.md
#
# Použití:
#   scripts/validate-decision.sh <cesta-k-md-souboru>
#
# Exit kódy:
...
ALLOWED_TYPES=("architecture" "product" "process" "tooling" "policy")
ALLOWED_STATUS=("proposed" "active" "superseded" "deprecated")
